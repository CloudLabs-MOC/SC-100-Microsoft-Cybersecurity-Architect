...
1. On the **Windows** taskbar, select the **Microsoft Edge** icon to open the browser.
...
1. Close the **Welcome to Compliance Manager** pop-up appears on window. 

    ![alt text](../media/lab3/wel.png)

1. From the **Compliance Manager** panel on the left, select **Assessments (1)**, select **+ Add assessment (2)**.

    ![alt text](../media/lab3/image-03.png)

1. From the **Base your assessment on a regulation** window, select **Select regulation**.

    ![alt text](../media/lab3/image-03-a.png)

1. In the search text box enter **`ISO/IEC 27001:2022` (1)**, then **select the regulation (2)** then select **Save (3)**.

    ![alt text](../media/lab3/image-04.png)

1. Select **Next**.

    ![alt text](../media/lab3/image-05.png)
...
1. It will take a few seconds to create the assessment, then select **Done** .
...
1. From the **ISO-27001 Audit assessment** page, select **Your improvement actions**.
    ...
    ![alt text](../media/lab3/image-09-a.png)

1. Set the filter for **Control family (1)** to **Physical controls (2)** and select **Apply (3)**.

    ![alt text](../media/lab3/image-09-b.png)
...
1. Select the **user (2)** and select **Assign (3)**.
...
1. Navigate to the Microsoft Purview portal **`https://purview.microsoft.com/`** and from there select **Solutions** > **Compliance Manager** > **Assessments** > **ISO-27001 Audit assessment** > **Your improvement actions (1)**.
1. From the upper right corner of the **ISO/IEC 27001:Assessment** page, select **Manage user access (2)**.
...
1. From the new **Manage user access** window, select the **Assessor (1)** tab and select **Add assessors (2)**.
    ...
    ![alt text](../media/lab3/image-13.png)

1. In the **Search for users (1)** text box, enter **`Nestor`** and press enter.

1. Select the **user (2)** and then select **Apply (3)**.
